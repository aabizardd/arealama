        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid mb-5">
                    <a class="btn btn-danger mb-2" href="<?=base_url('admin_listbarang')?>"><i
                            class="fas fa-arrow-left"></i> Back</a>

                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Detail Data Barang
                                        ...
                                        <div class="tab-pane fade show active" id="home" role="tabpanel"
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-sm-4 mt-3">
                                                    ...
                                                    <img src="<?=base_url('assets_praktikum/img_bahan_modul/') . $detail_barang['foto_barang']?>"
												...
												<span aria-hidden="true">&times;</span>
                                                    ...
                                                    <form method="POST"
                                                        action="<?=base_url('detail_barang/') . $this->uri->segment(2)?>"
                                                        enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Nama Barang</label>
                                                            <input type="text" class="form-control" id="nama_barang"
                                                                name="nama_barang" autocomplete="off"
                                                                value="<?=$detail_barang['nama_barang']?>">

                                                        </div>

                                                        <?php

$harga = "Rp " . number_format($detail_barang['harga'], 0, ',', '.');

?>

                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Harga</label>
                                                            <input type="text" class="form-control harga" id="rupiah"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="deskripsi_lainnya"
                                                                ...
                                                                rows="3"><?=$detail_barang['deskripsi_lainnya']?></textarea>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="link"
                                                                ...
                                                                autocomplete="off" value="<?=$detail_barang['link']?>">
                                                            <small class="text-info"><i>Contoh tautan:
                                                                    blablabna</i></small>
                                                        </div>

                                                        <input type="hidden" name="id_barang"
                                                            value="<?=$detail_barang['id_barang']?>">




                                                        <input type="hidden" id="foto_old" name="foto_bahan"
                                                            value="<?=$detail_barang['foto_barang']?>">
                                                        ...
                                                        <center>
                                                            ...
                                                            <a class="btn btn-outline-primary mt-2"
                                                                href="<?=base_url('admin_listbarang/')?>">Kembali</a>
                                                        </center>
