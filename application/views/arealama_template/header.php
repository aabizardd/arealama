            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            <li class="<?=($this->uri->segment(1) == '' ? 'active' : '')?>"><a href="<?=base_url()?>"
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        ...
                        <a href="<?=base_url('cart')?>"><img src="<?=base_url('assets_arealama/')?>img/icon/xcart.png"
                                alt="">
                        ...
                        <img class="ml-3" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown"
                            ...
                            src="<?=base_url('assets_arealama/img_profile/user_default.png')?>" width="30" height="30"
                            alt="">
