...
class Admin_kelolaadmin extends CI_Controller
{
    ...
    public function edit($id)
    {
        ...
        $data['title'] = "Kelola Profil Admin";

        $data['info_admin'] = $this->admin->get_where('admin', ['id_admin' => $id])->row_array();
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('template/header', $data);
            $this->load->view('admin/admin_profile_edit', $data);
    ...
    public function updateProfile()
    {
        ...
        redirect('admin_kelolaadmin/edit/' . $id_admin);
    }
